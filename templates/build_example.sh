...
dotnet publish src/Dhaf.Switchers.GoogleCloud/Dhaf.Switchers.GoogleCloud.csproj --configuration Release --no-restore -nowarn:CS1998 -r "$RID" -o "bin/$RID/ext/sw/google-cloud" /p:DebugType=None /p:DebugSymbols=false
...
mkdir -p $RID-artifacts/extensions/switchers/google-cloud
...
mv ./bin/$RID/ext/sw/google-cloud/* $RID-artifacts/extensions/switchers/google-cloud
